...
from mod_cobra import gibbs

DATA_REACTION_PH7 = os.path.join(os.path.dirname(os.path.abspath(gibbs.__file__)), 'data',
                                 'kegg_reactions_CC_ph7.0.csv')
DATA_COMPOUND_PH7 = os.path.join(os.path.dirname(os.path.abspath(gibbs.__file__)), 'data',
                                 'kegg_compounds_Alberty_ph7.0.csv')
